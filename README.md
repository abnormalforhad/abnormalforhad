  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><b>Shamir (3,4) Threshold DKG</b> over Galois Field GF(256) with Lagrange polynomial reconstruction.</li>
        <li><b>EIP-6963</b> multi-wallet connector + live Sepolia JSON-RPC telemetry.</li>
      </ul>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>Multi-node decentralized <b>AI validator consensus</b> on proposal validity.</li>
        <li>Eliminates central multisig gatekeepers and manual governance bottlenecks.</li>
      </ul>
      <sub><code>Python</code> · <code>GenLayer</code> · <code>Intelligent Contracts</code> · <code>LLM Consensus</code></sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><b>StableFX</b> engine integration and Circle CCTP cross-chain bridge tracking.</li>
        <li>Full-stack DeFi dashboard powered by Wagmi, Viem, and RainbowKit.</li>
      </ul>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>Real-time graph analysis and scoring engine.</li>
        <li>Cinematic telemetry dashboard.</li>
      </ul>
      <sub><code>JavaScript</code> · <code>Heuristics</code> · <code>Autonomous Radar</code></sub>
    </td>
  </tr>
</table>
...
├── Primitives         = Shamir Secret Sharing · Galois Field GF(256) · WebCrypto ECDSA
├── Ciphers & MACs     = AES-256-GCM · SHA-256 Commitments · EIP-191 Signatures
└── Privacy Models     = Threshold DKG · Sealed-Bid Max Computation · E3 Enclaves

[SMART CONTRACTS & CONSENSUS]
├── Decentralized AI   = GenLayer Intelligent Contracts · AI Consensus Meshes · Validator Gates
├── On-Chain VM        = EVM (Solidity) · Stacks (Clarity) · Monad · Circle Arc
└── Protocols & Infra  = EIP-6963 (Multi-Wallet) · EIP-1193 · Circle CCTP · Sepolia RPC

[SYSTEMS & AUTOMATION]
├── Core Languages     = Python · TypeScript · JavaScript · Solidity · Shell / PowerShell
├── High-Velocity      = Perpetual DEX Bots · Order Lifecycle State Machines · WebSocket Feeds
└── Client-Side Arch   = Zero-Backend PWAs · BroadcastChannel P2P Meshes · Canvas Telemetry
```
...
<p align="center">
  <sub><code>0xAF</code> // <i>Autonomous systems, verifiable compute, and unyielding code.</i></sub>
</p>
